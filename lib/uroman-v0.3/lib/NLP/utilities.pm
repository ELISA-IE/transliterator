...
";
   ...
   $add_javascript_function_s .= "
    function posteditAMR(snt_id,username,workset_name,button_tr_id,control) {
	  ...
	  tmp.write('    <form name=\"postedit-amr\" id=\"postedit-amr\" enctype=\"multipart/form-data\" action=\"http://www.isi.edu/cgi-bin/div3/mt/amr-editor/load-amr.cgi\" method=\"post\">\\n');
...
";
   ...
   $add_javascript_function_s .= "
    function set_workset_status (username, workset) {
       ...
       tmp.write('    <form name=\"set-status\" id=\"set-status\" enctype=\"multipart/form-data\" action=\"http://www.isi.edu/cgi-bin/div3/mt/amr-editor/set-status.cgi\" method=\"post\">\\n');
       tmp.write('      <table>\\n');
   ...
   $add_javascript_function_s .= "
    function open_amr_issue (annotator, snt_id, username, button_tr_id) {
	  ...
	  s.style.backgroundColor = \"#7799FF\";
       ...
       tmp.write('    <form name=\"open-issue\" id=\"open-issue\" enctype=\"multipart/form-data\" action=\"http://www.isi.edu/cgi-bin/div3/mt/amr-editor/set-status-v1.1.cgi\" method=\"post\">\\n');
       tmp.write('      <table>\\n');
...
";
   ...
   $add_javascript_function_s .= "
    function close_amr_issue (annotator, snt_id, issue_id, username) {
       ...
       tmp.write('    <form name=\"close-issue\" id=\"close-issue\" enctype=\"multipart/form-data\" action=\"http://www.isi.edu/cgi-bin/div3/mt/amr-editor/set-status-v1.1.cgi\" method=\"post\">\\n');
   ...
   $add_javascript_function_s .= "
    function amr_check (annotator, workset, source) {
	  ...
	  logsid = s2.value;
       ...
       var action = 'http://www.isi.edu/cgi-bin/div3/mt/amr-editor/check-amr.cgi';
